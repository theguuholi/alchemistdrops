...
config :alchemistdrops, :dev_to, api_key: System.get_env("DEV_TO_API_KEY")
...
#
#     PHX_SERVER=true bin/alchemistdrops start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :alchemistdrops, AlchemistdropsWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :alchemistdrops, AlchemistdropsWeb.Endpoint,
    ...
    check_origin: [
      "https://#{host}",
      "https://www.alchemistdrops.com",
      "https://alchemistdrops.com"
    ]
