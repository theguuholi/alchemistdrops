defmodule Alchemistdrops.Markdown do
  ...
  ## Examples
      ...
      iex> {:ok, html} = Alchemistdrops.Markdown.to_html("## Skills")
      iex> html =~ ~s(id="skills")
      true

      iex> Alchemistdrops.Markdown.to_html(nil)
      {:ok, ""}
  """
  ...
  ## Examples
      ...
      iex> {:ok, html} = Alchemistdrops.Markdown.to_html("## Build safely")
      iex> Alchemistdrops.Markdown.outline(html)
      [%{level: 2, id: "build-safely", label: "Build safely"}]
  """
  ...
  @doc """
  Returns normalized plain text from a generated HTML fragment.

  ## Examples

      iex> Alchemistdrops.Markdown.plain_text("<strong>Elixir</strong> &amp; Phoenix")
      "Elixir & Phoenix"
  """
